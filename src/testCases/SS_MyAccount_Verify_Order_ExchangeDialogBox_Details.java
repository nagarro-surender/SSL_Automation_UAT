...
public class SS_MyAccount_Verify_Order_ExchangeDialogBox_Details {
	...
	public void main() throws Exception {
		try {
			...
			Log.info("Exchange window visible");
			Thread.sleep(3000);
			MyAccount_Action.Verify_OrderDetailPage_ExchangeWindowEditQty_Functionality(iTestCaseRow);
